...
export function ErrorScreen({ message = 'An error occurred' }: { message?: string }) {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-b from-red-900 via-purple-900 to-black">
      <div className="text-center">
