...
// HAVE YOUR SAY PAGE HELP ELEMENTS
const HELP_ELEMENTS: HelpElement[] = [
  { 
    id: 'category-selector', 
    label: 'Category', 
    description: 'Choose the type of feedback you want to submit: Suggestion, Question, Complaint, or Report Quest. This helps us route your message to the right team.' 
  },
  { 
    id: 'message-input', 
    label: 'Your Message', 
    description: 'Type your feedback, question, or report here. Be as detailed as possible so we can help you better.' 
  },
];

interface HaveYourSayHelpOverlayProps {
  isActive: boolean;
  onElementClick: (element: HelpElement) => void;
  onExit: () => void;
}

export default function HaveYourSayHelpOverlay({ isActive, onElementClick, onExit }: HaveYourSayHelpOverlayProps) {
