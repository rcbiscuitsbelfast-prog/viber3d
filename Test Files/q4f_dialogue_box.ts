...
export function DialogueBox() {
  ...
  if (!activeDialogue || activeDialogue.length === 0) return null;

  return (
    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 w-full max-w-2xl px-4 pointer-events-auto">
      <div className="bg-gradient-to-b from-gray-900 to-black border-4 border-yellow-600 rounded-lg p-6 shadow-2xl">
        {/* NPC Name */}
