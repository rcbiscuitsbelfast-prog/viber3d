...
/**
 * Quest Templates - Predefined quest configurations
 */
export interface QuestTemplate {
  id: string;
  name: string;
  world: Quest['templateWorld'];
  description: string;
  thumbnail?: string;
  defaultEnvironment: QuestEnvironment;
...
/**
 * Builder Configuration - Quest creation settings
 */
...
/**
 * Analytics Event - Track quest interactions
 */
export interface AnalyticsEvent {
  type: 'play' | 'complete' | 'abandon' | 'task_complete';
  questId: string;
  timestamp: number;
  sessionId?: string;
...
/**
 * Asset Palette Entry - For builder UI
 */
export interface AssetPaletteEntry {
  ...
  name: string;
  thumbnail?: string;
  allowedInStyle?: ('combat' | 'nonCombat' | 'mixed')[];
}
