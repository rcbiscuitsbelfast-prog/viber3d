      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <button className="bg-white/10 backdrop-blur-sm text-white font-bold py-4 px-10 rounded-lg text-xl hover:bg-white/20 transition-all border-2 border-white/30">
              See Examples
            </button>
          </div>
        </div>
...
export function BuilderPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-black text-white">
      <div className="container mx-auto px-6 py-20">
        <h1 className="text-4xl font-bold mb-8">Quest Builder</h1>
        <p className="text-xl text-gray-300">
          Builder interface coming soon! This is where you'll create your quests.
        </p>
      </div>
    </div>
  );
