// src/components/ui/RewardModal.tsx
...
export function RewardModal() {
  ...
  const handleClose = () => {
    resetQuest();
    // TODO: Navigate to create quest page or home
  };

  return (
    <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center pointer-events-auto animate-fadeIn">
